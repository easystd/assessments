  ...
  questions: [
    ...
    },
    {
      ...
      options: [
        ...
        { label: "Oral sex (giving)", points: 2 },
        { label: "Oral sex (receiving)", points: 1 },
    ...
    },
    {
      ...
      type: "single",
      options: [
        { label: "Yes, yellowish or greenish discharge", points: 5 },
    ...
    },
    {
      ...
      options: [
        ...
        { label: "Sore throat that won't go away", points: 3 },
        { label: "Rectal pain, itching, or discharge", points: 3 },
    ...
    },
    {
      ...
      category: "symptoms",
      question:
        "Did these symptoms appear within the past 1–14 days after sexual contact?",
      type: "single",
      options: [
        { label: "Yes, they are recent", points: 3 },
        { label: "No, they appeared much later", points: 1 },
